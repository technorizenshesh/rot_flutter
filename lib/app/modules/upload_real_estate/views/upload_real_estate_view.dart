...
class UploadRealEstateView extends GetView<UploadRealEstateController> {
  const UploadRealEstateView({Key? key}) : super(key: key);
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.px),
                    dropDown(
                      hintText: StringConstants.bedRooms.tr,
                      onChanged: (value) =>
                    ...
                    SizedBox(height: 10.px),
                    dropDown(
                      hintText: StringConstants.bathRooms.tr,
                      onChanged: (value) =>
                    ...
                    dropDown(
                      hintText: StringConstants.packing.tr,
                      onChanged: (value) =>
