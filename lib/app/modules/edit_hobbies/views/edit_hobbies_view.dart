...
class EditHobbiesView extends GetView<EditHobbiesController> {
  const EditHobbiesView({Key? key}) : super(key: key);
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.px),
                    dropDown(
                      hintText: controller.time.value,
                      onChanged: (value) =>
                    ...
                    if (controller.serviceList.isNotEmpty)
                      dropDown(
                        hintText: controller.service.value,
                        onChanged: (value) =>
                    ...
                    SizedBox(height: 10.px),
                    dropDown(
                      hintText: controller.move.value,
                      onChanged: (value) =>
